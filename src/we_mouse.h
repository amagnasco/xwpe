...
int WpeMngMouseInFileManager(we_window_t* f);
int WpeMouseInFileDirList(int k, int sw, we_window_t* f);
int fl_wnd_mouse(int sw, int k, FLWND* fw);
int e_lst_mouse(int x, int y, int n, int sw, int max, int nf);
void e_eck_mouse(we_window_t* f, int sw);
int e_edt_mouse(int c, we_window_t* f);
int e_ccp_mouse(int c, we_window_t* f);
void e_cur_mouse(we_window_t* f);
