...
int e_about_WE(we_window_t* window);
int e_clear_desk(we_window_t* window);
int e_repaint_desk(we_window_t* window);
int e_sys_info(we_window_t* window);
...
int e_opt_read(we_control_t* control);
int e_add_arguments(char* str, char* head, we_window_t* window, int n, int sw,
                    struct dirfile** df);
...
W_OPTSTR* e_init_opt_kst(we_window_t* window);
...
int e_edt_options(we_window_t* window);
