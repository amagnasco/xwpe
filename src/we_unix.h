...
extern int (*e_u_deb_out)(we_window_t* f);
extern int (*e_u_cp_X_to_buffer)(we_window_t* f);
extern int (*e_u_copy_X_buffer)(we_window_t* f);
extern int (*e_u_paste_X_buffer)(we_window_t* f);
extern int (*e_u_change)(we_view_t* pic);
//extern int (*e_u_ini_size)(void);
extern int (*e_u_s_sys_end)(void);
extern int (*e_u_s_sys_ini)(void);
extern void (*e_u_setlastpic)(we_view_t* pic);
