...
int print_to_end_of_buffer(we_buffer_t* buffer, char* str, int wrap_limit);
...
int e_p_cmp_mess(char* srch, we_buffer_t* buffer, int* ii, int* kk, int ret);
...
int e_p_red_buffer(we_buffer_t* buffer);
